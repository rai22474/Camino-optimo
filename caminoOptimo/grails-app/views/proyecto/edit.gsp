                ...
                <div class="dialog">
                    <div>
                        <div>
                            ...
                            <div class="prop">
                                <div  class="name">
                                  <label for="codigo"><g:message code="proyecto.codigo.label" default="Codigo" /></label>
                                </div>
                                <div  class="value ${hasErrors(bean: proyectoInstance, field: 'codigo', 'errors')}">
                                    <g:textField name="codigo" maxlength="20" value="${proyectoInstance?.codigo}" />
                                </div>
                            </div>
                            ...
                            <div class="prop">
                                ...
                                <div  class="value ${hasErrors(bean: proyectoInstance, field: 'descripcion', 'errors')}">
                                    <g:textArea name="descripcion" value="${proyectoInstance?.descripcion}" />
                                </div>
                            </div>
